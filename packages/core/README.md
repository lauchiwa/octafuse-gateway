...
2.0 的关键 Schema 变更为 `0017_single_provider_key` 与 `0018_route_surfaces_pools`（上游编号 0015/0016，本 fork 为避开已上线的 0014/0015 而重编号）。升级前先阅读 [2.0 升级指南](../../docs/operators/migrations/single-provider-key-cutover.md)。
